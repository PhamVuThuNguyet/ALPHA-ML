...
from tensorflow.keras.layers import Dot, Reshape, Dense, Input, Embedding
...
df = pd.read_csv('./dataset-csv/disease-symptom-merged.csv')
...
# drop the symptoms that have fewer than 2 entries in the data set
...
dictDf.to_csv('./data/all-files-for-ml/Dictionary.csv',
...
model = Model([input_context, input_target], out)
