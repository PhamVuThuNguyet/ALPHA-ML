...
class Index extends Component {
    ...
    findSuggestions = (symptom) => {
        axios.post("http://localhost:5001" + 'api/sySuggest', {"symptom": symptom[0].value})
            .then((result) => {
                ...
                this.setState({
                    'message': result.data.join(', ') + ' also fit ' + symptom[0].label,
                    'open': true
                });
            });
    }
    ...
    render() {
        ...
        const params = windowHash.split("&");
        console.log(params[0])
        console.log(params[1])
        localStorage.setItem("access_tk", params[0]);
        localStorage.setItem("user_id", params[1]);
                                                    ...
                                                    <div className="mt-4">
                                                        ...
                                                        <div className="landing-box">
                                                            <Grid container spacing={24}>
                                                                ...
                                                                <Grid item xs={2}>
                                                                    <div className="pl-2">
                                                                        <Button variant="fab" variant="raised"
                                                                                size="small" color="primary"
                                                                                onClick={this.onSubmit}>
                                                                            <Search
                                                                                className={this.props.classes.smallSVG}/>
                                                                        </Button>
                                                                    </div>
                                                                </Grid>
                                                            </Grid>
